...
[ファイルと永続化](../../getting-started/coder/persistence/)では、Workspaceで保持されるファイルの保存先とBackup方法を説明しています。
...
- [ファイルと永続化](../../getting-started/coder/persistence/) — Workspaceの再構築後も残すべきファイルの保存先を確認できます。
