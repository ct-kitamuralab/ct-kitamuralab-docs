...
:::caution
作成後にWorkspaceの実行先を変更することはできません。変更が必要な場合は、新しいWorkspaceを作成してデータを移行します。詳細は[Workspaceの操作](../lifecycle/)を参照してください。
:::
...
2. [VS Code Web](../vscode-web/)を開いて、Editorが表示されることを確認します。
